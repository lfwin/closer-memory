...
if __name__ == '__main__':
    ...
    run_id = "WRN_16_1_noise01" + args.training_type + args.gen_type
    print(res_dir)
    res_dir = tensorboard_dir+run_id+"/model.tfl"
    angle = random.randint(0, 360)
    testing_num = 10000
    if args.training_type == 'cifar_binary':
        import load_cifar10_binary_label
        (X, Y), (X_test_ori, Y_test_ori) = load_cifar10_binary_label.load_data()
        X, Y = shuffle(X, Y)
